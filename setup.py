...
plugin_description = "Adds OPi.GPIO to OctoPrint-PSUControl as a sub-plugin"
plugin_author = "Simon Malpas with major thanks to Shawn Bruce"
plugin_author_email = "simalpas@gmail.com"
plugin_url = "https://github.com/simalpas/OctoPrint-PSUControl-OPiGPIO"
...
def params():
    ...
    # plugin_identifier to the plugin_package. That way OctoPrint will be
    # able to find the plugin and load it.
    entry_points = {
